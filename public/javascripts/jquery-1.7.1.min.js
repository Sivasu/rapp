...
(function (a, b) {
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function () {
        ...
        e.fn = e.prototype = {constructor:e, init:function (a, d, f) {
            ...
            e.isArray(a) ? E.apply(d, a) : e.merge(d, a), d.prevObject = this, d.context = this.context, b === "finder" ? d.selector = this.selector + (this.selector ? " " : "") + c : b && (d.selector = this.selector + "." + b + "(" + c + ")");
            return d
        }, each:function (a, b) {
    ...
    f.fn.extend({find:function (a) {
        ...
        var e = this.pushStack("", "finder", a), g, h, i;
        for (c = 0, d = this.length; c < d; c++) {
